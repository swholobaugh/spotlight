  ...
  return (
      <div className="flex flex-col items-center bg-white p-4">
        ...
        <div className='text-lg text-center mb-4'>
          Nominate an Aggie to the Aggie Spotlight! Each nomination is active for the current month and the nominee with the most votes will be featured in the Aggie Spotlight. Please fill in all of the fields below.</div>
        <NominateForm
          formState={formState}
