...
const Hall = () => {
  ...
  return (
    <div className='flex flex-col justify-center items-center p-4'>
      <h1 className='text-3xl text-app-accent font-bold mb-2'>Spotlight Hall of Fame</h1>
      <section className='w-2/3 p-6'>
        <div className='flex flex-col justify-center text-center items-center'>
          <div className='mb-4 text-[#500000]'>
            <p className='text-lg font-bold'>Welcome to the Aggie Spotlight Hall of Fame!</p>
